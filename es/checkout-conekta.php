...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div id="pay-cash" class="alert-conekta display-none">Toma captura o guarda el numero de referencia para realizar el pago, seras redirigid@ en 30 segundos para recibir tu id de pedido.</div>
    <div id="pay-complete" class="alert-conekta display-none">Tu pago se ha realizado exitosamente, en unos segundos seras redireccionad@ para recibir tu id de compra.</div>
    <div id="conektaIframeContainer" class="view-conekta large-12"></div>
  </div>
