            ...
            <div class="cell spaceSection spaceX flex-center" style="height: 200px;
                ...
                <div class="grid-x" style="font-size: 1.4rem;">
                    <div class="large-12 medium-12 grid-padding-x text-center">
                        ...
                        <p class="morado">Gracias por tu pedido <span class="fw-bold"><?php echo $user[0]['nombre'] ?></span>, Tu ID de compra es <span class="fw-bold">"<?php echo $user[0]['ID_compra'] ?>"</span>, al realizar tu pago en efectivo o transferencia, tu compra sera validada.</p>
                    </div>
                </div>
            </div>
