...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="product-box">
    ...
    <button class="buy-button"><a style="color: white;" href="https://buy.stripe.com/bIY8yR3n42vibTy9F0">Comprar Ahora</a></button>
  </div>
  <div class="product-box">
    <img src="../img/blaack.jpg" alt="Product 2" />
    <h3>KIT BLACK DETECTA 13 ITS</h3>
    <p class="price">$4,250</p>
    <button class="buy-button"><a style="color: white;" href="https://buy.stripe.com/7sIcP72j0d9WaPucRd">Comprar Ahora</a></button>
  </div>
  <div class="product-box">
    <img src="../img/platinuumm.jpg" alt="Product 3" />
    <h3>KIT PLATINUM DETECTA 12 ITS</h3>
    <p class="price">$2,799</p>
    <button class="buy-button"><a style="color: white;" href="https://buy.stripe.com/3cs5mFg9Q4Dqf5K6sQ">Comprar Ahora</a></button>
  </div>
  <div class="product-box">
    <img src="../img/bphpp.jpg" alt="Product 4" />
    <h3>KIT VPH	</h3>
    <p class="price">$2,620</p>
    <button class="buy-button"><a style="color: white;" href="https://buy.stripe.com/aEU6qJ5vc6Ly9Lq04t">Comprar Ahora</a></button>
  </div>
</div>
