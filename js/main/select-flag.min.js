    ...
    return (
      ...
      this.init(),
      {
        setCountryByPhoneCode: function (t) {
          ...
          o._ccPicker.html(o.createCountryListItem(c.code, c.phoneCode)),
            o._ccDialCodeTrackerField.val(c.phoneCode),
            o._ccCountryCodeTrackerField.val(c.code),
            (o._ccSelectedCountry = { code: c.code, phoneCode: c.phoneCode }),
        ...
        disable: function () {
          e(o.element).prop("disabled", !0),
            o._ccPicker.off("click"),
            o._ccPicker.css("cursor", "default");
        },
        enable: function () {
          e(o.element).prop("disabled", !1),
            o._ccPicker.off("click"),
            o._ccPicker.on("click", function (t) {
              e.isEmptyObject(o._list)
                ? o.createCountryList(o)
                : o.destroyCountryList(o),
                t.stopPropagation();
            }),
  ...
  e.extend(r.prototype, {
    init: function () {
      ...
      (this._ccPicker = e(
        ...
        (this._ccCountryCodeTrackerField = e("<input>")
          .attr({
            type: "hidden",
    ...
    createCountryList: function (t) {
      ...
      (t._list = e("<ul/>", { class: "cc-picker-code-list" }).appendTo("body")),
        ...
        e.each(t._ccData, function (c, o) {
          var i = e("<li>", {}).appendTo(t._list);
          /* var i = e("<li>", { text: o.countryName }).appendTo(t._list); */
          e(i).data("countryItem", o),
            e(i).prepend(t.createCountryListItem(o.code, o.phoneCode)),
            e(i).on("click", function () {
              t.selectCountry(t, e(this)), t.destroyCountryList(t);
            }),
            o.phoneCode === t._ccSelectedCountry.phoneCode &&
        ...
        t.options.countryFilter &&
          ...
          t._filter.on("keyup", function (t) {
            var c = e(this).val();
            e('.cc-picker-code-list li:not(:ccContains("' + c + '"))').hide(),
              e('.cc-picker-code-list li:ccContains("' + c + '")').show();
          }));
    },
    ...
    selectCountry: function (t, c) {
      ...
      (this._ccSelectedCountry = o),
        t._ccPicker.html(t.createCountryListItem(o.code, o.phoneCode)),
        t._ccCountryCodeTrackerField.val(o.code),
        t._ccDialCodeTrackerField.val(o.phoneCode),
        e(t.element).trigger("countrySelect", o);
    },
    ...
    (e.fn.CcPicker = function (t) {
      if ("string" == typeof arguments[0]) {
        ...
        return (
          this.each(function () {
            ...
            c = e.data(this, "plugin_" + i)[n].apply(this, s);
          }),
          c !== o ? c : this
        );
      }
      if ("object" == typeof t || !t)
        ...
        $('.cc-picker-code-list').append('<div>asdas</div>')
    });
});