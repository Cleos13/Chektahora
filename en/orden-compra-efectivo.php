...
require '../api/get/verifyOrderCash.php';
?>
<!doctype html>
            ...
            <div class="cell spaceSection spaceX flex-center" style="height: 200px;
                ...
                <div class="grid-x" style="font-size: 1.4rem;">
                    <div class="large-12 medium-12 grid-padding-x text-center">
                        ...
                        <p class="morado">Thank you for your order <span class="fw-bold"><?php echo $user[0]['nombre']; ?></span>, Your purchase ID is <span class="fw-bold">"<?php echo $user[0]['ID_compra']; ?>"</span>, When making your payment in cash or transfer, your purchase will be validated.</p>
                    </div>
                </div>
            </div>
