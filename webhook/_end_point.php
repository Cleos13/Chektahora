...
if(strpos($ex[4], $s)){
    ...
    if($json['operation']['payment']['status'] == 'APPROVED'){
        ...
        $conn->query("UPDATE its SET status_customer = 'Pago recibido, verificar en panel (opcional)', status = 1, notify_pay = '$status_pay', hora_status_customer='$hora' WHERE ID_compra ='$id'");
