...
$page = $data->data->object->metadata->Pagina;
$type = $data->type;
if (($type == 'charge.paid' || $type == 'order.paid') && $page == 'ChektAhora'){
    ...
    $conn->query("UPDATE its SET estatus_pay = 1, type_pay='Conekta', fecha_pago='$fecha', hora_pago='$hora', time_pago='$time', orden='$id_order' WHERE ID_compra ='$id'");
